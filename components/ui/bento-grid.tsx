...
const BentoCard = ({
  ...
  >
    ...
    <div
      className={cn(
        "pointer-events-none absolute bottom-0 flex w-full translate-y-10 transform-gpu flex-row items-center opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100",
        "p-4"
      )}
    >
      <Button variant="ghost" asChild size="sm" className="pointer-events-auto text-sm sm:text-base">
        <a href={href}>
          {cta}
