  ...
  return (
    ...
    <div className="container mx-auto flex flex-col lg:flex-row items-center">
      ...
      <div className="lg:w-1/2 right-0 lg:pl-12">
        <h2 className="text-4xl font-bold mb-8 text-black">Ready to Experience <span className="text-[#cc4c03]">Premium Chef Services</span>?</h2>
        <p className="text-2xl mb-8 text-gray-700">Download our app now and bring culinary excellence to your home!</p>
        ...
        <div className="flex flex-row space-x-4 sm:space-x-6 pb-4 justify-center">
          <Link href="https://play.google.com/store/apps/details?id=your-app">
            <button className="cursor-pointer ">
              <div className="flex max-w-48 h-12 px-3 gap-2 border border-r-2 border-solid border-gray-500 rounded-xl items-center justify-center hover:bg-[#cc4c03] bg-black text-white sm:h-14">
          ...
          <Link href="https://apps.apple.com/your-app">
            <button className="cursor-pointer">
              <div className="flex max-w-48 h-12 px-3 gap-2 border border-r-2 border-solid border-gray-500  rounded-xl items-center justify-center bg-black hover:bg-[#cc4c03] text-white sm:gap-3 sm:h-14">
