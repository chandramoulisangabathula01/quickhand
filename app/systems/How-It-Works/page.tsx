...
const HowItWorksPage = () => {
  ...
  // Handle responsive layout and scroll triggers
  useEffect(() => {
    const handleResize = () => {
    ...
    if (!isMobile) {
      // Set up ScrollTriggers for desktop view
      ...
      // Handle download section visibility
      ScrollTrigger.create({
        trigger: "#download",
        start: "top 90%",
        onEnter: () => {
  ...
  // Desktop view component with optimized animations
  const DesktopView = () => (
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <Image
                ...
                priority={currentStep < 2} // Prioritize loading first two images
              />
            </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h3 className="text-3xl font-semibold mb-6 text-[#cc4c03]">{steps[currentStep].title}</h3>
  ...
  // Mobile view component with IntersectionObserver for better performance
  const MobileView = () => {
    return (
        ...
        {steps.map((step, index) => {
          ...
          return (
            <motion.div
              ...
              animate={inView ? { opacity: 1, x: 0 } : { opacity: 0.5, x: index % 2 === 0 ? -30 : 30 }}
              transition={{ duration: 0.5 }}
            >
              <Image
                src={step.image}
  ...
  return (
    <div className="how-it-works-page" ref={containerRef}>
      ...
      >
        How it <span className="text-[#cc4c03]">works</span>
      </motion.h1>
      ...
      <div id="download" className="bg-gray-100 py-16 border-t-2 border-b-2 border-[#cc4c03]/20">
        <div className="container mx-auto flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 right-0 lg:pl-12">
            <h2 className="text-4xl font-bold mb-8 text-black">Ready to <span className="text-[#cc4c03]">Experience Premium Service?</span></h2>
            ...
            <div className="flex flex-row space-x-4 sm:space-x-6 justify-center">
              <Link href="https://play.google.com/store/apps/details?id=your-app">
                <button className="cursor-pointer">
                  <div className="flex max-w-48 h-12 px-3 gap-2 border border-r-2 border-solid border-[#cc4c03] rounded-xl items-center justify-center hover:bg-gray-800 bg-[#cc4c03] text-white sm:h-14">
              ...
              <Link href="https://apps.apple.com/your-app">
                <button className="cursor-pointer">
                  <div className="flex max-w-48 h-12 px-3 gap-2 border border-r-2 border-solid border-[#cc4c03]  rounded-xl items-center justify-center bg-[#cc4c03] hover:bg-gray-800 text-white sm:gap-3 sm:h-14">
